    ...
    <div>
      ...
      <div className="container px-5">
        <div className="container-fluid font-bold px-5">
          ...
          <h1 className="fs-2 text-start text-COOPAQ-orange">
            Assentamento Boa União recebe equipe de ATER em mais um “Dia de
            Campo”
          </h1>
          <p className="fs-5 text-start">
            <em>
              O evento que tem objetivo de fomentar a capacitação do produtor
              rural, abordou temas como uso de drone e precificação
            </em>
          </p>
          ...
          <div className="row">
            <div className="">
              ...
              <p>
                <em>Daniele Soares, jornalista</em>
              </p>
              <div className="fs-5 m-1" style={{ textAlign: "justify" }}>
                <p>
                  Nesta manhã de domingo, nossa equipe de ATER - Assistência
                  Técnica de Extensão Rural, realizou mais um Dia de Campo.
                </p>
                <p>
                  Dessa vez, a ação aconteceu no Assentamento Boa União, no
                  município de Porto Calvo, litoral Norte e contou com toda a
                  equipe de ATER, dos diretores da Coopaq, Salatiel Alves
                  responsável pelo setor Comercial e Mayara Costa, responsável
                  pela Juventude e Mulheres, além de Rúbia e Gilson, técnicos do
                  Sebrae.
                </p>
                <p>
                  O Dia de Campo que faz parte do Projeto Coqueirais, tem sido
                  realizado com o objetivo de fomentar a capacitação do produtor
                  rural, por meio de Convênio, em parceria com a deputada
                  Federal Tereza Nelma.
                </p>
                <p>
                  O tema deste encontro abordado pelo setor de ATER , foi o “Uso
                  de Drone na Agricultura”, ministrado pelo técnico em
                  agroecologia da Coopaq, José Feitosa, em seguida, os
                  representantes do Sebrae ministraram um curso sobre
