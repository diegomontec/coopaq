      ...
      <div className="container">
        <div className="container-fluid font-regular">
          ...
          <h1 className="fs-2 text-COOPAQ-orange text-center font-demibold">
            Café com Mulheres do Campo é sucesso e marca início dos trabalhos do
            Matriz Delas, em 2025
          </h1>
          <p className="fs-6 text-justify text-center fst-italic">
            Mais de 100 agricultoras da região Norte participaram do evento, que
            contou com palestra, dinâmicas e entrega de brindes
          </p>
            ...
            <div className="">
              <div className="d-flex align-items-center justify-content-center mt-2 text-center">
                <img
                  ...
                  src={imageNews}
                  alt="imageNews"
                  className="w-100 float-md-start me-md-3 mb-3"
                  style={{ maxWidth: "800px" }}
                />
              </div>

              <p className="pt-2 pb-2 mb-0">
                <em>Daniele Sores, assessoria Coopaq</em>
              </p>

              <div className="fs-5 m-1" style={{ textAlign: "justify" }}>
                <p>
                  O Centro de Logística da Coopaq recebeu, no último sábado
                  (13), mais de 100 agricultoras de vários locais da região
                  Norte para um café da manhã especial, em comemoração ao Dia
                  Internacional das Mulheres. O evento, organizado pelo Projeto
                  Social Matriz Delas, fez sucesso e marcou o início dos
                  trabalhos da instituição em 2025.
                </p>

                <p>
                  As participantes tiveram a oportunidade de ouvir uma palestra
                  da consultora do Sebrae, Desiree Farah, que abordou temas
                  relevantes para o empreendedorismo feminino. Além disso, o
                  evento contou com dinâmicas divertidas, entrega de brindes
                  para todas as participantes e um sorteio de presentes.
                </p>

                <p>
                  Um dos momentos mais importantes do evento foi a aplicação de
                  um questionário para entender as principais necessidades das
                  mulheres participantes. Os resultados serão utilizados para
                  oferecer cursos profissionalizantes e oportunidades de
                  empreendedorismo nas localidades de origem das participantes.
                </p>

                <p>
                  "Agradecemos a todas as participantes e principalmente à
                  Coopaq, em nome do presidente Romullo Dantas, por apoiar esse
                  projeto e suprir todas as nossas necessidades para fazer desse
                  evento um momento especial", disse Ilva Dantas, idealizadora
                  do MD.
                </p>

                <p>
                  O evento foi um marco importante para o Matriz Delas, que
                  inicia seus trabalhos em 2025 com o objetivo de empoderar as
                  mulheres da região Norte e promover o empreendedorismo
                  feminino no campo.
                </p>
              </div>
            </div>
