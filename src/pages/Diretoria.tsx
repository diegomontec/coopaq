  ...
  return (
    <div className='container-fluid'>
      <Header />
          ...
          <h1 className='container' style={{ fontSize: '1rem', textAlign: 'justify' }}>A Diretoria da Cooperativa é composta por líderes comprometidos com os princípios do cooperativismo e o desenvolvimento sustentável do meio rural. À frente da presidência, o Diretor Presidente conduz as estratégias com visão de futuro, fortalecendo a união entre os cooperados e impulsionando o crescimento coletivo. O Diretor Financeiro assegura a gestão responsável dos recursos, garantindo estabilidade e transparência nas finanças. A Diretora Secretária organiza e registra os processos internos com rigor e clareza, promovendo uma comunicação eficiente entre os setores. A Diretora de Jovens e Mulheres atua com dedicação na inclusão, capacitação e valorização desses públicos, estimulando a renovação e diversidade no campo. Já o Diretor de Produção e Comércio lidera ações voltadas à melhoria da produtividade e à ampliação de mercados, gerando mais oportunidades para os associados. Juntos, formam uma equipe sólida, alinhada aos valores cooperativistas e ao compromisso com o fortalecimento da agricultura familiar.</h1>
        </div>  
        <Container>
